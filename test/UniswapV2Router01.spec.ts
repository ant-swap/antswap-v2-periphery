...
enum RouterVersion {
  AntswapV2Router01 = 'AntswapV2Router01',
  AntswapV2Router02 = 'AntswapV2Router02'
}

describe('AntswapV2Router02{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.AntswapV2Router01]: fixture.router01,
        [RouterVersion.AntswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.AntswapV2Router01]: 101876,
              [RouterVersion.AntswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.AntswapV2Router01]: 138770,
              [RouterVersion.AntswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
